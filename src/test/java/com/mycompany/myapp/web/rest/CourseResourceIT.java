...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().courseID(DEFAULT_COURSE_ID).name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().courseID(UPDATED_COURSE_ID).name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return course;
    }
    ...
    void putNewCourse() throws Exception {
        ...
        updatedCourse.courseID(UPDATED_COURSE_ID).name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.courseID(UPDATED_COURSE_ID).name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
