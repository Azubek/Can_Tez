...
class GradeResourceIT {
    ...
    private static final Integer DEFAULT_GRADE_ID = 1;
    private static final Integer UPDATED_GRADE_ID = 2;
    ...
    public static Grade createEntity(EntityManager em) {
        Grade grade = new Grade().gradeID(DEFAULT_GRADE_ID).name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return grade;
    }
    ...
    public static Grade createUpdatedEntity(EntityManager em) {
        Grade grade = new Grade().gradeID(UPDATED_GRADE_ID).name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return grade;
    }
    ...
    void createGrade() throws Exception {
        ...
        assertThat(testGrade.getGradeID()).isEqualTo(DEFAULT_GRADE_ID);
    ...
    void getAllGrades() throws Exception {
        ...
        restGradeMockMvc
            ...
            .andExpect(jsonPath("$.[*].gradeID").value(hasItem(DEFAULT_GRADE_ID)))
    ...
    void getGrade() throws Exception {
        ...
        restGradeMockMvc
            ...
            .andExpect(jsonPath("$.gradeID").value(DEFAULT_GRADE_ID))
    ...
    void putNewGrade() throws Exception {
        ...
        updatedGrade.gradeID(UPDATED_GRADE_ID).name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        ...
        Grade testGrade = gradeList.get(gradeList.size() - 1);
        assertThat(testGrade.getGradeID()).isEqualTo(UPDATED_GRADE_ID);
    ...
    void partialUpdateGradeWithPatch() throws Exception {
        ...
        partialUpdatedGrade.gradeID(UPDATED_GRADE_ID).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateGradeWithPatch() throws Exception {
        ...
        partialUpdatedGrade.gradeID(UPDATED_GRADE_ID).name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
