...
class ExamResourceIT {
    ...
    private static final Integer DEFAULT_EXAM_ID = 1;
    private static final Integer UPDATED_EXAM_ID = 2;
    ...
    private static final Integer DEFAULT_EXAM_TYPE = 1;
    private static final Integer UPDATED_EXAM_TYPE = 2;
    ...
    void createExam() throws Exception {
        ...
        assertThat(testExam.getExamID()).isEqualTo(DEFAULT_EXAM_ID);
    ...
    void putNewExam() throws Exception {
        ...
        Exam testExam = examList.get(examList.size() - 1);
        assertThat(testExam.getExamID()).isEqualTo(UPDATED_EXAM_ID);
