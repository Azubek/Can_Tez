...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Lecturer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class LecturerResource {
    ...
    public ResponseEntity<Lecturer> updateLecturer(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, lecturer.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Lecturer> partialUpdateLecturer(
        ...
        Optional<Lecturer> result = lecturerRepository
            ...
            .map(existingLecturer -> {
                if (lecturer.getLecturerID() != null) {
                    existingLecturer.setLecturerID(lecturer.getLecturerID());
                }
                ...
                if (lecturer.getSurname() != null) {
                    existingLecturer.setSurname(lecturer.getSurname());
                }
                if (lecturer.getDateOfBirth() != null) {
                    existingLecturer.setDateOfBirth(lecturer.getDateOfBirth());
                }
                if (lecturer.getMobile() != null) {
                    existingLecturer.setMobile(lecturer.getMobile());
                }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, lecturer.getId().toString())
        );
    }
