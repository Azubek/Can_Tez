...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './lecturer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LECTURER_LIST actions', async () => {
    ...
    it('dispatches FETCH_LECTURER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LECTURER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LECTURER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LECTURER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LECTURER actions', async () => {
      const expectedActions = [
        {
