  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="tezApp.exam.home.createOrEditLabel" data-cy="ExamCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField label="Description" id="exam-description" name="description" data-cy="description" type="text" />
