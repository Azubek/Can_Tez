...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_EXAMRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXAMRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXAMRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXAMRESULT actions', async () => {
      const expectedActions = [
        {
